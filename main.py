...
with st.sidebar:
    page = option_menu(
        ...
        # styles={
        #     "container": {"padding": "5!important", "background-color": "#00004d"},
        #     "icon": {"color": "white", "font-size": "20px"},
        #     "nav-link": {"font-size": "16px", "text-align": "left", "margin": "0px", "color": "white"},
        #     "nav-link-hover": {"background-color": "#8a2be2"},
        #     "nav-link-active": {"background-color": "#7a1ea1"},
...
if page == "Introduction":
    ...
    if uploaded_file is not None:
        try:
            ...
            # Perform OCR with a loading spinner
            ...
            if results:
                ...
                st.success(f"Detected {len(results)} text region(s)")
                
                # Detailed results
                with st.expander("Detailed Text Regions"):
                    for i, (bbox, text, prob) in enumerate(results, 1):
                        ...
                        with col2:
                            ...
                            if prob > 0.8:
                                ...
                                color = "red"
                            st.markdown(f"<p style='color:{color}'>{prob:.2%}</p>", unsafe_allow_html=True)
